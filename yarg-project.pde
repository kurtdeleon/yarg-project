...
PImage menubg; PImage results;
PImage pic1; PImage pic2; PImage pic3;

// Audio variables.

int songs = 3; int bgm = 3;
AudioPlayer[] player = new AudioPlayer[songs + bgm]; 
Minim minim; AudioSample beatpress;
AudioSample select; AudioSample enter;
AudioSample quit; AudioSample death;

//Beatmap variables.

PImage game1; PImage game2; PImage game3;
PImage r; PImage g; PImage b; PImage y;
PImage rankS; PImage rankA; PImage rankB;
PImage rankC; PImage rankD; PImage gameover;
boolean r_press; boolean g_press;
boolean b_press; boolean y_press;
int r_time; int g_time; int health;
int b_time; int y_time;
int score; float maxScore;
int combo; int max_combo;
int judge; boolean songEnd;
int startMillis; int perfect;
int good; int bad; int miss;
ArrayList<Float> rNotes;
ArrayList<Float> gNotes;
ArrayList<Float> bNotes;
ArrayList<Float> yNotes;
Float temp; Float speed;

//Other resources

PFont title; PrintWriter map1;
PrintWriter map2; PrintWriter map3;
boolean rPressed; boolean gPressed;
boolean bPressed; boolean yPressed;
boolean enterPressed; boolean rightPressed; 
boolean leftPressed; String[] lines;
String k; float v;
...
void setup() {
  ...
  gameState = 0; exitAlpha = 0;
  beatAlpha = 0; beatOn = false;
  r_press = false; r_time = 0;
  g_press = false; g_time = 0;
  b_press = false; b_time = 0;
  y_press = false; y_time = 0;
  rPressed = false; gPressed = false;
  bPressed = false; yPressed = false;
  enterPressed = false; 
  rightPressed = false;
  leftPressed = false;
